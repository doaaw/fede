...
export default class extends Command {
  ...
  async execute ({ interaction }: { interaction: CommandInteraction; }): Execute {
    ...
    let listCollector: InteractionCollector<SelectMenuInteraction> = message.createMessageComponentCollector({ componentType: ComponentType.SelectMenu, filter: (select_menu: SelectMenuInteraction) => select_menu.customId === 'configure' });
